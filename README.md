# Run GitHub CI in Haiku ![Test](https://github.com/vmactions/haiku-vm/workflows/Test/badge.svg)
...
You can use [AnyVM](https://github.com/anyvm-org/anyvm) to run the Haiku VM locally for debugging. It's the same environment as in the GitHub Actions.
