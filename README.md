# Run GitHub CI in Haiku 

![Test](https://github.com/vmactions/haiku-vm/workflows/Test/badge.svg)
...
>
> Just describe what you want in plain language, e.g. *"run my tests on Haiku"* or *"check that my project builds on Haiku aarch64"*, and the agent generates a correct, ready-to-commit `test.yml`. It will:
>
...
Use this action to run your CI in Haiku.

The github workflow only supports Ubuntu, Windows and MacOS. But what if you need to use Haiku?
...
We use Qemu to run the Haiku VM.
